document.addEventListener('DOMContentLoaded', function() {
    ...
    const animateOnScroll = function() {
        const elements = document.querySelectorAll('.category-card, .service-card, .step, .feature-card');
    ...
    const animatedElements = document.querySelectorAll('.category-card, .service-card, .step, .feature-card');
