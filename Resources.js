document.addEventListener('DOMContentLoaded', function() {
    ...
    const animateOnScroll = function() {
        const elements = document.querySelectorAll('.category-card, .resource-card, .path-card, .step');
    ...
    const animatedElements = document.querySelectorAll('.category-card, .resource-card, .path-card, .step');
